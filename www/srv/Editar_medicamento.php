    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            <div class="card card-body">
                <form action="Editar_medicamento.php?id=<?php echo $_GET['id'];?>" method="POST">
                    ...
                    <div class="from-group">
                        ...
                        <input type="submit" class="btn btn-success btn-block" name="edit" value="Actualizar medicamento">
                    </div>
                </form>
            </div>
        </div>
